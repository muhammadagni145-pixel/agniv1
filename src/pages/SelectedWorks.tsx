...
const projects = [
  {
    ...
    stack: "Integrated Circuit (7408, 7432, 7404) / Push Buttons / LEDs / Resistors",
    description: "A digital logic control system built using 7404, 7432, and 7408 logic ICs. The system uses three push buttons as inputs to control five LED outputs, demonstrating fundamental concepts of digital logic, circuit design, and hardware implementation.",
    links: { live: "https://drive.google.com/drive/folders/15rkBBOGkPS5zer6I2BiqPCtJnhK9Yh2C", code: "#" },
    image: "/PROJECT 1.jpeg",
    cta: "View Project"
  },
  {
    id: "002",
    title: " Arduino Motor Control System",
    stack: "Arudino /  L293D / DC Motor/  LDR / 16×2 LCD",
    description: "An Arduino-based motor control system that combines sensor input, speed adjustment, and real-time LCD feedback. The system uses an LDR and potentiometer to control motor behavior while displaying its current status and direction on a 16×2 LCD.",
    links: { live: "https://drive.google.com/drive/folders/15rkBBOGkPS5zer6I2BiqPCtJnhK9Yh2C", code: "#" },
  ...
  },
  {
    ...
    stack: "ESP 32 / EFTTT / Google Assistant ",
    description: "A smart lighting system that connects an ESP32 to a voice-controlled IoT setup. Voice commands are used to control the lamp remotely, demonstrating the integration of microcontrollers, wireless connectivity, and smart home automation.",
    links: { live: "https://drive.google.com/drive/folders/15rkBBOGkPS5zer6I2BiqPCtJnhK9Yh2C", code: "#" },
  ...
  },
  {
    ...
    stack: "Tyscript / HTML / React / GSAP",
    description: "A personal portfolio website designed to showcase my projects, technical interests, skills, and learning journey across electronics, IoT, and software development.",
    links: { live: "https://drive.google.com/drive/folders/15rkBBOGkPS5zer6I2BiqPCtJnhK9Yh2C", code: "#" },
